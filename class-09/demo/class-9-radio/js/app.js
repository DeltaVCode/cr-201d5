...
function Pet(name, breed, imageName, interests, isGoodWithKids, isGoodWithDogs, isGoodWithCats, shots) {
  this.name = name;
  this.breed = breed;
...
Pet.prototype.render = function() {
  ...
  if(this.shots){
    h3.textContent = 'This pup has their shots.';
  } else {
    h3.textContent = 'This pup has no shots!!!!!';
  }
...
var firstPet = new Pet('Nova','Lab', 'labradorDog', ['chewy toys', 'playin keep away', 'Blue Eyes', 'good girl'], true, true, true, true);
firstPet.setAge();
firstPet.getInterests();
var secondPet = new Pet('Tiger','American shorthair', 'diabloBlanco', ['inquisitive', 'needy', 'small', 'whiskery'], true, true, true, true);
secondPet.setAge();
secondPet.getInterests();
var thirdPet = new Pet('Iggy', 'iguana', 'littleDragon', ['green', 'scaly', 'chill', 'dragony'], true, true, true, true);
thirdPet.setAge();
...
function handleFormSubmitted(event){
  ...
  //radio button
  var shots = event.target.shots.checked;



  var newPet = new Pet(nameValue,breedValue,imageValue,interestsValue,isGoodWithKids, isGoodWithDogs, isGoodWithCats,shots);
